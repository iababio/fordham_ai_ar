...
Future<void> onARKitViewCreated(ARKitController controller) async {
  ...
  void selectedLocation(int index) {
    kDebugMode ? print('Selected location: $index') : null;
    setState(() {
      location = index + 1;
        ...
        body: Stack(
          ...
          children: [
            if (_isCameraInitialized && _showARKitView)
              ...
              PanoramaPage(
                arkitController: arkitController!,
                panaoramaImage: cardInfo[location]["panoramaImage"]!,
              ),
    ...
    final container = ARKitBox(
      ...
      materials: [
        ARKitMaterial(
          ...
          diffuse: ARKitMaterialProperty.image(cardInfo[location]['image']!),
          doubleSided: true,
        ),
      ],
    );
...
// Title text adjustment
  ...
  ARKitNode _createSubText() {
    final addressText = ARKitText(
      text: cardInfo[location]['subText']!,
      extrusionDepth: 0.01,
      materials: [
        ARKitMaterial(
      ...
      materials: [
        ARKitMaterial(
          ...
          diffuse: ARKitMaterialProperty.image(
              cardInfo[location]['bottomImage']! + i.toString() + '.png'),
          doubleSided: true,
        ),
      ],
    );
