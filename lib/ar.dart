...
import 'package:flutter_realtime_detection/components/dialog/info_dialog.dart';
...
List<CameraDescription> cameras = [
  CameraDescription(
    name: 'front',
    lensDirection: CameraLensDirection.front, sensorOrientation: 90,
  ),
  CameraDescription(
    name: 'back',
    lensDirection: CameraLensDirection.back, sensorOrientation: 90,
  ),
];
...
class _ArVrPageState extends State<ArVrPage>
        ...
        children: [
          _showARKitView
            ...
            onARKitViewCreated: onARKitViewCreated,
              ...
              // : DetectorWidget(toddleARKitView: toddleARKitView),
          : DetectObj(cameras),
          Positioned(
            top: 60,
            left: 20,
  ...
  void onARKitViewCreated(ARKitController controller) {
    ...
    // Adding AR objects for demonstration
